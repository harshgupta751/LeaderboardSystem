  ...
  return (
    <div className="w-full max-w-md mx-auto mb-6">
      <button
        ...
        className="w-full bg-gradient-to-r from-yellow-400 via-orange-400 to-red-400 hover:from-yellow-500 hover:via-orange-500 hover:to-red-500 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed text-white font-bold py-4 px-6 rounded-2xl transition-all duration-300 transform hover:scale-105 disabled:hover:scale-100 shadow-2xl hover:shadow-3xl disabled:shadow-none flex items-center justify-center space-x-3 border-2 border-white/30"
      >
        {isLoading ? (
          <>
