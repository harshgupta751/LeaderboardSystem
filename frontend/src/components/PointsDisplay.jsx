...
export default function PointsDisplay({ randomPoints, totalPoints, username, isVisible }) {
  ...
  return (
    <div className="w-full max-w-md mx-auto mb-6">
      <div className="bg-gradient-to-br from-yellow-400 via-orange-400 to-red-400 rounded-2xl p-6 text-white shadow-2xl transform transition-all duration-500 hover:scale-105 border-2 border-white/30 relative overflow-hidden">
